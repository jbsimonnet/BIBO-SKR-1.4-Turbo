...
#define STRING_CONFIG_H_AUTHOR "(JB Simonnet for BIBO SKR 1.4 Turbo with TMC2209 drivers)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "BIBO JB Edition"
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 350, 350, 10, 45 }
...
/**
 * The "Manual Probe" provides a means to do "Auto" 3ed Leveling without a probe.
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MANUAL_PROBE_START_Z 0.20  // (mm) Comment out to use the last-measured height
#endif
  ...
  #define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_LAYER_HEIGHT   0.20  // (mm) Default layer height for G26.
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 90, 80, -90, -80 } // (mm) Left, Front, Right, Back insets
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT X_MAX_POS // X_CENTER // ((X_BED_SIZE) / 2)  // (mm) X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT Y_MAX_POS // Y_CENTER // ((Y_BED_SIZE) / 2)  // (mm) Y point for Z homing
#endif
